...
## Status (2026-09-23 03:00 EDT, end of overnight run 2)
...
3. Remaining Stage 2/3/4 gaps: Collections room, services/addons Home rows, TMDB-driven detail rows (cast cards, More Like This), skip intro/outro, Anime4K, AVPlayer engine, sync writes (still read-only), Live TV EPG/Xtream/favorites.
