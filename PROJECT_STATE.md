...
3. Remaining Stage 2/3/4 gaps: services/addons Home rows, TMDB/TVDB collection sources, TMDB-driven detail rows (cast cards, More Like This), skip intro/outro, Anime4K, AVPlayer engine, Live TV catch-up/Xtream VOD.
