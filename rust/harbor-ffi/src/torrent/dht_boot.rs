// Port of upstream src-tauri/src/torrent_engine/dht_boot.rs (verbatim): a side DHT that seeds
// a new torrent with peers within 3 s while the session DHT is still warming up.
