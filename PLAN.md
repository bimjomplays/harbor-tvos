...
**Status 2026-09-23 (evening):** Stage 0–3 ✔. Stage 4 mostly ✔ (player chrome, resume prompt + leave confirm, progress sync, online subtitles + offset/size, audio/subtitle tracks, skip pill, up-next, Anime4K shaders, source switch, error/connecting cards; AVPlayer engine + display-mode matching pending). Stage 5 ✔ (Library tabs incl. media servers, Addons manager, watchlist). Stage 6 partial (Plex/Jellyfin/Emby: connect, index, sync runner, picker copies, progress write-back; torrents/librqbit pending). Stage 7 mostly ✔ (Anime room; anime detail path pending). Stage 8 ✔ (M3U/Xtream, favorites, XMLTV + short-EPG guide grid, catch-up, focus panel). Stage 9 mostly ✔ (BP settings catalog + native panels; themes pending). Stage 10 pending (phone remote/handoff). Stage 11 ✔ (ESPN hub, watch matching). Stage 12+ pending. Parity audit: docs/parity-audit-2026-09-23.md (top-15 items 1–13 done; instant play, onboarding taste/phone steps, ambient backdrop, anime detail path, collections TMDB/TVDB remain).
